...
class Salary6Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        computeBtn.setOnClickListener {
            ...
            if (correctInput) {
                ...
                DailySalary.setSixth((totalSalary).toString())
    ...
    private fun loadNextScreen() {
        var intentLoadNextActivity = Intent(this, Salary7Activity::class.java)
