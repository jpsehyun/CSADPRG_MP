...
class Salary7Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        computeBtn.setOnClickListener {
            ...
            try {
                ...
                Toast.makeText(this, "Please input correct time", Toast.LENGTH_SHORT).show()
                correctInput = false
            }
            ...
            if (correctInput) {
                ...
                DailySalary.setSeventh((totalSalary).toString())
    ...
    private fun loadNextScreen() {
        var intentLoadNextActivity = Intent(this, WeeklyActivity::class.java)
